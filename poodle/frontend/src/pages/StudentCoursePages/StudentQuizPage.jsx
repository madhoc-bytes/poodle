...
import { Button, Grid, TextField, Typography, Checkbox, FormControlLabel, Box, Radio, RadioGroup, Dialog, DialogTitle, DialogActions } from '@mui/material';
...
const StudentQuizPage = () => {
    ...
    const handleAnswerChange = (e) => {
        setSelectedAnswers({ ...selectedAnswers, [currentQuestionIndex]: e.target.value });
    }
        ...
        <div>
            <Box sx={{ display: "flex", flexDirection: "column", backgroundColor: "lightblue", height: "100vh"}}>
                ...
                <Box sx={{ margin: "0 auto"}}>
                    <Typography variant="h2">{quiz.name}</Typography>
                </Box>
                ...
                <Box sx={{ display: "flex", flexGrow: 1}}>
                    ...
                    <Box width={ "25%" }>
                        ...
                        <Grid container justifyContent="space-between">
                            ...
                            {quiz.questions.map((question, index) => (
                                ...
                                sx={{
                                    backgroundColor: currentQuestionIndex === index ? "#B19CD7" : "#FFE6EE",
                                    "&:hover": {
                    ...
                    {/* Actual Question */}
                    <Box sx={{ diplay: "flex", flexDirection: "column", backgroundColor: "lightgreen", flexGrow: 1}}>
                        {/* <Grid item> */}
                                ...
                                quiz.questions[currentQuestionIndex].answers.map((answer, index) => (
                                    ...
                                    >
                                        <FormControlLabel 
                                            ...
                                            control={<Radio />} 
                                            label={answer}
                                            style={{backgroundColor: selectedAnswers[currentQuestionIndex] === answer ? 'red' : 'transparent'}}
                                        />
                                    </RadioGroup>
                                ))
                            ) : (
                    ...
                    {/* Submit Button */}
                    <Box sx={{ width: "25%", textAlign: "center", backgroundColor: "pink"}}>
                        <Button
                            variant='outline'
                            color="secondary"
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", height: "50px", backgroundColor: "purple"}}>
